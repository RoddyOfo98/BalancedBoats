	...
	public static void main(String[] args) 
	{
		...
		do
		{
			...
			do
			{
				...
				System.out.println("Please enter the size of the n by n boat that needs balancing(n >= 4 and if n > 11 it will not be printed): ");
				try
				{
				n = scanner.nextInt();
				}
			...
			scanner.nextLine();
			do{
				System.out.println("Nice Boat! You wanna make another one? Type Y to make another one, Type N if you're done. \n");
				input = scanner.next();
				if(input.equals("N")) 
				{
					isFinished = true;
