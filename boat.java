...
public class boat 
{
    ...
    public void balence()
    {
        if(isEven)
        {
            ...
            while(true)
            {
                ...
                if(weightCounter==this.size+1) break;
                travel = travel - 2;
        ...
        else
        {
            ...
            while(true)
            {
                ...
                if(weightCounter==this.size) break;
                travel = travel - 2;
                for(int x=0; x < travel; x++)
                {
                 //   System.out.println("3");
    ...
    {
       // System.out.println("The total moment on x/size = " + Math.abs(xTotalMoment)/this.size);
        //System.out.println("The total moment on y/size = " + Math.abs(yTotalMoment)/this.size);
